...
\section{PROFILE}
Mr. Brunner is an imagery and 3D subject matter expert and Python developer for Esri's Professional Services team. He works in close collaboration with Esri's 3D and imagery teams on innovative research and development projects that involve 3D feature extraction, image analysis, content quality assessment, and 3D augmented reality. He also composes creative presentations and software demonstrations for Esri.\\	
...
\section{EXPERIENCE}
   ...
   \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
    {\bf Imagery Scientist} \>Esri     \>July 2011 -- Present\\
                             \>St. Charles, MO
...
Led effort to develop a framework to evaluate large amounts of geographic content. Developed Python tools to automate content assessment. Developed imagery processing pipeline that extracted 3D pointclouds from oblique aerial photos. Has presented at numerous conferences on topics including, but not limited to 3D augmented reality, imagery analysis, and geographic data quality.
   ...
   \begin{tabbing}
   \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
    {\bf Associate Scientist} \>Sensing Strategies, Inc.     \>March 2008 -- July 2011\\
                             \>Pennington, NJ
   \end{tabbing}\vspace{-20pt}      % suppress blank line after tabbing
...
%Helped configure ground stations.  Calibrated sensors used for LASER detection and ranging.  Ran %field tests of remote sensing equipment.
   ...
   \begin{tabbing}
   \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
    {\bf Graduate Student Researcher} \>Rice University     \>June 2005 -- March 2008\\
                             \>Houston, TX
   \end{tabbing}\vspace{-20pt}      % suppress blank line after tabbing
...
The American Society for Photogrammetry and Remote Sensing, ASPRS (2011 - Present)\\
ASPRS Heartland Region Director (2015 - present)\\
...
%Spitzer Archival Research Program \#40773: \textit{Mapping Molecular Hydrogen Excitation and Mass %in Nearby Galaxies from the SINGS Archive.}  PI: Brunner, G. Amount awarded: \$96,765.  (For more i%nfo, see http://ssc.spitzer.caltech.edu/geninfo/ar/abs-ar4/40773.txt)
