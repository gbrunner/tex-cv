...
\begin{tabbing}
	\hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
	{\bf Advanced Python for GIS} \>https://github.com/gbrunner/adv-python-for-gis-and-rs\>\\
	Write Description here
\end{tabbing} \vspace{-20pt}

\begin{tabbing}
	\hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
	{\bf Esri Raster Functions} \>https://github.com/Esri/raster-functions\>\\
	A set of powerful Python tools for on-the-fly image processing and raster analysis in ArcGIS. Lead contributor to the project since Fall 2017 adding new tools, code, and documentation. 
\end{tabbing}\vspace{-20pt}  
	
\begin{tabbing}
	\hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
	{\bf State of the Data} \>https://github.com/ngageoint/state-of-the-data/\>\\
	Python based ArcGIS geoprocessing tools that evaluate the quality of topographic feature data in terms of its completeness, logical consistency, positional accuracy, source lineage, temporal accuracy, and thematic accuracy.
\end{tabbing} \vspace{-20pt}
	
\begin{tabbing}
	\hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
	{\bf GEOINT in Motion} \>https://github.com/ngageoint/geoint-in-motion\>\\
	Write Description here
\end{tabbing} \vspace{-20pt}
