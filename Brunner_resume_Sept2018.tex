...
Currently serves as the lead on multiple projects within Esri. He is the lead developer on an effort to develop data quality and data comparison algorithms. He is the lead scientist on an effort to implement large scale raster processing and machine learning algorithms using Amazon Web Services and ArcGIS Image Server. He is the lead developer for the Esri Python raster function development effort (https://github.com/Esri/raster-functions/). Has presented at numerous conferences, including, but not limited to Esri's Federal GIS Conference, Esri's Developer Summit, and Domino Data Lab's Data Science Pop-up.
   ...
   \begin{tabbing}
	...
	\>St. Charles, MO
\end{tabbing}\vspace{-20pt}      % suppress blank line after tabbing
Led effort to develop a framework to evaluate large amounts of geographic content. Developed Python tools to automate content assessment. Developed imagery processing pipeline that extracted 3D pointclouds from oblique aerial photos. Has presented at numerous conferences on topics including, but not limited to 3D augmented reality, imagery analysis, and geographic data quality.
